    ...
    <div className="flex h-screen">
      <div className="w-1/2 flex flex-col justify-center p-12 bg-white">
        ...
        <form className="flex flex-col space-y-2 mt-2">
          <Label htmlFor="nome" className="text-lg font-light">Nome completo</Label>
          <Input type="text" placeholder="Nome completo" className="rounded-md" />
          ...
          <Input type="password" placeholder="Senha" className="rounded-md" />
            <Label htmlFor="telefone" className="text-lg font-light">Telefone</Label>
          <Input type="text" placeholder="Telefone" className="rounded-md" />
          <Button className="bg-blue-600 text-white p-3 rounded-md">Cadastrar</Button>
        </form>
        <p className="mt-4">Possui uma conta? <Link href="/login" className="text-blue-600">Entrar</Link></p>
      </div>
      <div className="w-1/2 bg-gray-200 flex items-center justify-center object-cover">
        <Image src="/doador-image.png" alt="Doador" width={500} height={500} className="h-full w-full" />
      </div>
    </div>
  );
}